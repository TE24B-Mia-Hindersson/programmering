...
while (money > 0)
{
    ...
    else if (choice.Length == 2 && int.TryParse(choice[0], out int itemnum) && int.TryParse(choice[1], out int quantity) && quantity > 0)
    {
...
while (true)
{
    ...
    else if (choice2.Length == 2 && int.TryParse(choice2[0], out itemnum) && int.TryParse(choice2[1], out quantity) && quantity > 0)
    {
        if (itemnum == 1 && money >= flower * quantity)
        {
            ...
            Console.WriteLine($"    This item has removed {flower * quantity} coins from your wallet");
    ...
    else if (itemnum == 2 && money >= horn * quantity)
    {
        ...
        Console.WriteLine($"    This item has removed {horn * quantity} coins from your wallet");
        money -= horn * quantity;
        for (int i = 0; i < quantity; i++)
    ...
    else if (itemnum == 3 && money >= potion * quantity)
    {
        ...
        Console.WriteLine($"    This item has removed {potion * quantity} coins from your wallet");
...
while (true)
{
    ...
    else if (choice3.Length == 2 && int.TryParse(choice3[0], out itemnum) && int.TryParse(choice3[1], out quantity) && quantity > 0)
    {
        if (itemnum == 1 && money >= hat * quantity)
        {
            ...
            Console.WriteLine($"    This item has removed {hat * quantity} coins from your wallet");
            money -= hat * quantity;
            for (int i = 0; i < quantity; i++)
    ...
    else if (itemnum == 2 && money >= tooth * quantity)
    {
        ...
        Console.WriteLine($"    This item has removed {tooth * quantity} coins from your wallet");
    ...
    else if (itemnum == 3 && money >= wand * quantity)
    {
        ...
        Console.WriteLine("                           ._.");
        Console.WriteLine($"    This item has removed {wand * quantity} coins from your wallet");
        money -= wand * quantity;
        for (int i = 0; i < quantity; i++)
...
while (true)
{
    ...
    int selling;
    if (int.TryParse(sellchoice, out selling) && selling >= 1 && selling <= items.Count)
    {
        string solditems = items[selling - 1];
        int sellprice = itempricing(solditems) / 2;
        Console.WriteLine("--------------------------------------------------------");
        Console.WriteLine($"   You sold {items[selling - 1]} for {sellprice} coins.");
        Console.WriteLine("--------------------------------------------------------");
        money += sellprice;
        items.RemoveAt(selling - 1);
        Console.ReadLine();
        Console.Clear();
    }
    else
